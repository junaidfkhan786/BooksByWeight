            ...
            map((allcoupons) => {
                ...
                for (let i = 0; i < allcoupons.length; i++) {
                    ...
                    console.log(allcoupons)
                        // if (allcoupons[i]['coupon_amount'] > this.total && allcoupons[i]['percentage'] == false ) {
                        //     console.log('here')
                        //   allcoupons.splice(i, 1); i--;
                    ...
                    if (allcoupons[i] != undefined) {
                        if (allcoupons[i]['expiry_date'] != null && allcoupons[i]['expiry_date'] < a || allcoupons[i]['coupon_amount'] > this.total && allcoupons[i]['percentage'] == false) {
                          console.log('here')
                            allcoupons.splice(i, 1); i--;
                            // delete this.allcoupons[i]['_id']
                            // delete this.allcoupons[i]['coupon_amount']
